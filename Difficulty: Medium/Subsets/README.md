...
<p><span style="font-size: 14pt;"><strong>Expected Time Complexity:</strong> O(2<sup>n</sup>)<br><strong>Expected Auxiliary Space:</strong> O((2<sup>n</sup>)*length of each subset)</span></p>
