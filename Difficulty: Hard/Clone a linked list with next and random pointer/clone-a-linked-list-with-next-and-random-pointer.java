...
class Solution {
    ...
    Node copyList(Node head) {
        ...
        Node temp = head;
        while(temp != null){
            if(!hm.containsKey(temp.data)) hm.put(temp.data,new Node(temp.data));
            if(temp.next != null) {
                if(!hm.containsKey(temp.next.data)){
                    hm.put(temp.next.data,new Node(temp.next.data));
                }
                hm.get(temp.data).next = hm.get(temp.next.data);
            }
            if(temp.random != null) {
                if(!hm.containsKey(temp.random.data)){
                    hm.put(temp.random.data,new Node(temp.random.data));
                }
                hm.get(temp.data).random = hm.get(temp.random.data);
            }
            temp = temp.next;
        }
        return hm.get(head.data);
    }
}
